...
It is possible to use multiple story map templates in your story. For example, you may find that one type of template, like the swipe and spyglass, is effective for telling a story about the changing racial composition and segregation in your neighborhood, while the tour would help you explain how your neighborhood's non-profit organizations sustain social and systemic integration in this diversifying community. There are a few ways of combining and embedding multiple ESRI story map templates, and selecting the best method to combine or embed is going to depend on the templates you are using and the viewing experience you intend to create for the audience. You are not required to use multiple templates, but if you feel like your story would benefit from the features of multiple templates, meet with Francine during her office hours or [book an appointment](https://go.oncehub.com/FrancineStephens) with her, so that the two of you can brainstorm the best method for combining or embedding your different story map templates and walk through the steps for combining or embedding. 
