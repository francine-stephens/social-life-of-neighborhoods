...
Let's press onward to making the graduated symbol map for crime! As you might guess, we want to select the **Change style button** on the hot spot layer. Follow the steps below: 
