...
*One caveat to this is that the time-aware app is that it does not work on maps created with the New Map Viewer (e.g., dot density).* For these maps, you will need to use the second option of having separate layers for each decade that viewers scroll or click through.
