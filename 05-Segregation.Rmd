...
With the divergence index, we are representing the departure of the tract's racial make-up to the super-unit of interest, which in this case is the city.


## Segregation between Places

Now, let's turn to a larger scale - the region. The Schafran chapter made an argument about segregation being more prominent *between places across a region* instead of just *between neighborhoods in the same city*. To get a sense of segregation between places in a region, we need to transform our units. In our maps and graphs, our sub-unit needs to change from census tracts/neighborhoods to places - cities, suburbs, and exurbs - in a region. The super-unit is now the region, instead of the city.
