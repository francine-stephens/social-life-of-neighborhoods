...
If you decide that you want to make additional maps, but are not sure about where to find the data or how to import the data into AGOL, email or meet with Francine to figure out the appropriate steps to take.  
...
7. Then, navigate your AGOL content page, from your list of contents, select the web-app that you just created.
...
* [Importing Custom Symbols][Importing Custom Symbols (Optional)] - To use custom symbols instead of AGOL's icons. 
